...
var format_MobilePopUp_4 = new ol.format.GeoJSON();
var features_MobilePopUp_4 = format_MobilePopUp_4.readFeatures(json_MobilePopUp_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MobilePopUp_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MobilePopUp_4.addFeatures(features_MobilePopUp_4);
var lyr_MobilePopUp_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MobilePopUp_4, 
                style: style_MobilePopUp_4,
                popuplayertitle: 'Mobile Pop-Up',
                interactive: true,
                title: '<img src="styles/legend/MobilePopUp_4.png" /> Mobile Pop-Up'
            });
var group_EssentialTools = new ol.layer.Group({
                                layers: [lyr_Home_3,lyr_MobilePopUp_4,],
                                fold: 'open',
...
lyr_ESRISatellite_0.setVisible(false);lyr_ESRIGraydark_1.setVisible(true);lyr_ESRIBoundariesPlaces_2.setVisible(true);lyr_Home_3.setVisible(true);lyr_MobilePopUp_4.setVisible(true);
...
lyr_MobilePopUp_4.set('fieldAliases', {'fid': 'fid', 'Name': 'Name', 'Address': 'Address', });
lyr_Home_3.set('fieldImages', {'fid': '', 'Name': '', 'Address': '', 'Program': '', 'Customer ID': '', });
lyr_MobilePopUp_4.set('fieldImages', {'fid': '', 'Name': '', 'Address': '', });
lyr_Home_3.set('fieldLabels', {'fid': 'no label', 'Name': 'no label', 'Address': 'no label', 'Program': 'no label', 'Customer ID': 'no label', });
lyr_MobilePopUp_4.set('fieldLabels', {'fid': 'hidden field', 'Name': 'inline label - always visible', 'Address': 'inline label - always visible', });
lyr_MobilePopUp_4.on('precompose', function(evt) {
