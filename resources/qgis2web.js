...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 12, minZoom: 8
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-13756855.669341, 4388014.629787, -13408330.905496, 4610970.594376], map.getSize());
    ...
    element: (() => {
        ...
        if (90 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '64 unique users served as of April 2026.<br /><br />© 2026 by Manzanita Works. All Rights Reserved.<br />';
            }
